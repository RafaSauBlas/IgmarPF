            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        ...
                        @csrf
                            <h3 class="text-center text-white ">Registrar Usuarios</h3>
                            ...
                            <div class="form-group">
                                <label for="password" class="text-white">Confirmar contraseña:</label><br>
...
<br>
                            ...
                            <div class="form-group">
                              <br>
                                <button type="submit" name="submit" class="btn btn-white btn-md">Registrar Usuario</button>
                            </div>
